...
var $author$project$Main$PosixZone = F2(
	function (posix, zone) {
...
var $author$project$Main$localDateTime = F2(
	function (posix, zone) {
				...
				if (res.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						...
						A2(
							...
							A3($elm$core$Task$map2, $author$project$Main$PosixZone, $elm$time$Time$now, $elm$time$Time$here)));
				} else {
					var info = res.a;
					return _Utils_Tuple2(
			...
			case 'ReceiveDate':
				...
				return _Utils_Tuple2(
					A2(
						...
						days,
						A2($author$project$Main$localDateTime, posix, zone)),
					A2(
						...
						A2(
							$elm$core$Task$andThen,
							function (today) {
								return A2($elm$browser$Browser$Dom$setViewport, 0, today.element.y);
							},
...
var $author$project$Main$formatDate = function (dt) {
	var yearStr = A3(
		$elm$core$String$padLeft,
		4,
		_Utils_chr('0'),
		$elm$core$String$fromInt(
			$PanagiotisGeorgiadis$elm_datetime$DateTime$getYear(dt)));
	var monthStr = A3(
		$elm$core$String$padLeft,
		2,
		_Utils_chr('0'),
		$elm$core$String$fromInt(
			$PanagiotisGeorgiadis$elm_datetime$Calendar$monthToInt(
				$PanagiotisGeorgiadis$elm_datetime$DateTime$getMonth(dt))));
	var dayStr = A3(
		$elm$core$String$padLeft,
		2,
		_Utils_chr('0'),
		$elm$core$String$fromInt(
			$PanagiotisGeorgiadis$elm_datetime$DateTime$getDay(dt)));
	...
	function (maybedatetime, day) {
		...
		var datestr = function () {
			if (maybedatetime.$ === 'Just') {
				...
				return $author$project$Main$formatDate(datetime);
			} else {
				return '';
			}
		}();
		...
		var summary = function () {
			...
			if (!_v0.b) {
				...
				var some_events = _v0;
				return 'You have ' + ($elm$core$String$fromInt(
					$elm$core$List$length(some_events)) + (' events ' + (datestring + '.')));
			}
		}();
